        ...
        for method in $methods; do
            ...
            if [ ! -f $output_dir/train_logits.csv ]; then
                ...
                python -m llmcal2.scripts.affine_calibration \
                    ...
                    --val_logits outputs/adaptation/$model/lora/$dataset/size=$size/rs=$random_state/val_logits.csv \
                    --val_labels outputs/adaptation/$model/lora/$dataset/size=$size/rs=$random_state/val_label.csv \
